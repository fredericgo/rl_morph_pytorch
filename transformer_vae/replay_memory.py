...
class ReplayMemoryDataset(Dataset):
    def __init__(self, memory_file, topology, state_size, max_limbs):
        """
        ...
        self.max_state_dim = ROOT_DIM + self.state_size * (self.max_limbs - 1)
    ...
    def __getitem__(self, idx):
        ...
        topology = torch.full((self.max_limbs,), -1, dtype=torch.int32)
